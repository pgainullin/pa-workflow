...
### 📄 Documents
- **PDF files** - Analyzed using Google Gemini's native PDF understanding (gemini-3-pro-preview) for comprehensive analysis including text, images, tables, and formatting
...
- Analyzed using Google Gemini's vision capabilities (gemini-3-pro-preview)
...
response = await self.genai_client.aio.models.generate_content(
    model="gemini-3-pro-preview",  # Using multi-modal model with PDF support
...
response = await self.genai_client.aio.models.generate_content(
    model="gemini-3-pro-preview",  # Using vision-capable model
