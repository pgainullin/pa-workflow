...
from basic.utils import is_retryable_error, download_file_from_llamacloud, upload_file_to_llamacloud


def test_is_retryable_error_with_503():
    """Test that 503 errors are identified as retryable."""
    error = Exception("503 UNAVAILABLE. {'error': {'code': 503, 'message': 'The model is overloaded. Please try again later.', 'status': 'UNAVAILABLE'}}")
